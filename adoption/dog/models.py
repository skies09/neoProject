...
class Dog(AbstractModel):
    ...
    good_with_dogs = models.BooleanField(
        null=True, 
        blank=True,
        help_text="Whether the dog gets along with other dogs"
    )
    good_with_cats = models.BooleanField(
        null=True, 
        blank=True,
        help_text="Whether the dog gets along with cats"
    )
    good_with_children = models.BooleanField(
        null=True, 
        blank=True,
        help_text="Whether the dog is good with children"
    )
    ...
    is_crossbreed = models.BooleanField(
        help_text="Whether the dog is a crossbreed"
    )
    extra_information = models.TextField(
        null=True, 
        blank=True,
        help_text="Additional information about the dog"
    )
    image = models.ImageField(
        null=True, 
        blank=True, 
        upload_to="adoption/dog/images",
